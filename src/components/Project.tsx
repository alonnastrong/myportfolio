...
function Project() {
    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                <div className="project-media">
                    <img src={alonnaPoster} alt="Auburn CASE REU Research Poster" />
                </div>
            ...
            <div className="project">
                <div className="project-media">
                    <img src={p5js} alt="P5JS Self Portrait" />
                </div>
                <h2>P5JS Self Portrait</h2>
                <p>This project is a generative self-portrait created using p5.js for my Prototyping With Code course. The composition is built entirely from code using custom shapes, Bézier curves, and ellipses to form facial features, hair textures, and clothing. The portrait explores contrast and duality through asymmetrical hair styling and a vertical dividing line that splits the canvas.</p>
            </div>
            <div className="project">
                <a href="https://alonnaa.neocities.org/" target="_blank" rel="noreferrer" className="project-media-link">
                    <div className="project-media project-media--neocities">
                        <div className="neocities-preview">
                            <span>🌸 my sketchbook 🌸</span>
                            <span className="neocities-sub">creative code</span>
                        </div>
                    </div>
                </a>
                <h2><a href="https://alonnaa.neocities.org/" target="_blank" rel="noreferrer">My Sketchbook — Creative Code</a></h2>
                <p>A Neocities site showcasing p5.js creative coding projects made for my Prototyping With Code course, including generative art, interactive sketches, and visual experiments.</p>
            </div>
        </div>
    </div>
    );
